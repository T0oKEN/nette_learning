...
class Container_76d176457b extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'ArrayAccess' => [2 => ['01', 'application.1', 'application.2', 'application.4', 'application.5', 'application.6']],
		'Countable' => [2 => ['01']],
		'IteratorAggregate' => [2 => ['01']],
		'Traversable' => [2 => ['01']],
		'Nette\Application\Routers\RouteList' => [['01']],
		'Nette\Application\UI\Presenter' => [
			2 => ['application.1', 'application.2', 'application.4', 'application.5', 'application.6'],
		],
	...
	public function createServiceContainer(): Container_76d176457b
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=quickstart', 'root', null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_76d176457b $container)
			{
